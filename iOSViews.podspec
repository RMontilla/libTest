...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Rmontilla/iOSViews'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Rmontilla' => 'r.montilla.a@gmail.com' }
  s.source           = { :git => 'https://github.com/Rmontilla/iOSViews.git', :tag => s.version.to_s }
